  ...
  lessons: [
    // ---------------------------------------------------------------
    {
      ...
      sections: [
        ...
        { kind: "calc", tool: "position-size", title: "Size a leveraged position" },
        { kind: "quiz",
    ...
    // ---------------------------------------------------------------
    {
      ...
      sections: [
        ...
        { kind: "chart", variant: "trend",
          caption: "Macro shifts show up as regime changes — toggle the trend and picture the whole market, not one stock, turning with the tide." },
        { kind: "quiz",
    ...
    // ---------------------------------------------------------------
    {
      ...
      sections: [
        ...
        { kind: "prose", text: "Set the payoff above to a long put and picture it stacked on top of your stocks: as the stock falls, the put climbs to meet it, and your combined loss flattens out. That kinked, floor-shaped result is exactly what portfolio insurance buys you — pain capped below a level you chose, for the price of the premium." },
